...
public class files extends ModuleBody {
    ...
    static {
        ...
        path$Qu = new ModuleMethod(filesVar, 1, Lit0, 4097);
        filepath$Qu = new ModuleMethod(filesVar, 2, Lit1, 4097);
        URI$Qu = new ModuleMethod(filesVar, 3, Lit2, 4097);
        absolute$Mnpath$Qu = new ModuleMethod(filesVar, 4, Lit3, 4097);
        path$Mnscheme = new ModuleMethod(filesVar, 5, Lit4, 4097);
        path$Mnauthority = new ModuleMethod(filesVar, 6, Lit5, 4097);
        path$Mnuser$Mninfo = new ModuleMethod(filesVar, 7, Lit6, 4097);
        path$Mnhost = new ModuleMethod(filesVar, 8, Lit7, 4097);
        path$Mnfile = new ModuleMethod(filesVar, 9, Lit8, 4097);
        path$Mndirectory = new ModuleMethod(filesVar, 10, Lit9, 4097);
        path$Mnparent = new ModuleMethod(filesVar, 11, Lit10, 4097);
        path$Mnlast = new ModuleMethod(filesVar, 12, Lit11, 4097);
        path$Mnextension = new ModuleMethod(filesVar, 13, Lit12, 4097);
        path$Mnport = new ModuleMethod(filesVar, 14, Lit13, 4097);
        path$Mnquery = new ModuleMethod(filesVar, 15, Lit14, 4097);
        path$Mnfragment = new ModuleMethod(filesVar, 16, Lit15, 4097);
        file$Mnexists$Qu = new ModuleMethod(filesVar, 17, Lit16, 4097);
        file$Mndirectory$Qu = new ModuleMethod(filesVar, 18, Lit17, 4097);
        file$Mnreadable$Qu = new ModuleMethod(filesVar, 19, Lit18, 4097);
        file$Mnwritable$Qu = new ModuleMethod(filesVar, 20, Lit19, 4097);
        delete$Mnfile = new ModuleMethod(filesVar, 21, Lit20, 4097);
        rename$Mnfile = new ModuleMethod(filesVar, 22, Lit21, 8194);
        copy$Mnfile = new ModuleMethod(filesVar, 23, Lit22, 8194);
        create$Mndirectory = new ModuleMethod(filesVar, 24, Lit23, 4097);
        directory$Mnfiles = new ModuleMethod(filesVar, 25, Lit24, 4097);
        $Mn$Grpathname = new ModuleMethod(filesVar, 26, Lit25, 4097);
