...
public class numbers extends ModuleBody {
    ...
    static {
        ...
        exact$Qu = new ModuleMethod(numbersVar, 7, Lit9, 4097);
        inexact$Qu = new ModuleMethod(numbersVar, 8, Lit10, 4097);
        zero$Qu = new ModuleMethod(numbersVar, 9, Lit11, 4097);
        positive$Qu = new ModuleMethod(numbersVar, 10, Lit12, 4097);
        negative$Qu = new ModuleMethod(numbersVar, 11, Lit13, 4097);
        max = new ModuleMethod(numbersVar, 12, Lit14, -4096);
        min = new ModuleMethod(numbersVar, 13, Lit15, -4096);
        abs = new ModuleMethod(numbersVar, 14, Lit16, 4097);
        ...
        numerator = new ModuleMethod(numbersVar, 19, Lit21, 4097);
        denominator = new ModuleMethod(numbersVar, 20, Lit22, 4097);
        floor = new ModuleMethod(numbersVar, 21, Lit23, 4097);
        ceiling = new ModuleMethod(numbersVar, 22, Lit24, 4097);
        truncate = new ModuleMethod(numbersVar, 23, Lit25, 4097);
        round = new ModuleMethod(numbersVar, 24, Lit26, 4097);
        rationalize = new ModuleMethod(numbersVar, 25, Lit27, 8194);
        exp = new ModuleMethod(numbersVar, 26, Lit28, 4097);
        log = new ModuleMethod(numbersVar, 27, Lit29, 4097);
        sin = new ModuleMethod(numbersVar, 28, Lit30, 4097);
        cos = new ModuleMethod(numbersVar, 29, Lit31, 4097);
        tan = new ModuleMethod(numbersVar, 30, Lit32, 4097);
        asin = new ModuleMethod(numbersVar, 31, Lit33, 4097);
        acos = new ModuleMethod(numbersVar, 32, Lit34, 4097);
        ...
        moduleMethod2.setProperty("source-location", "numbers.scm:148");
        lambda$Fn2 = moduleMethod2;
        ModuleMethod moduleMethod3 = new ModuleMethod(numbersVar, 35, null, 4097);
        moduleMethod3.setProperty("source-location", "numbers.scm:152");
        lambda$Fn3 = moduleMethod3;
        ModuleMethod moduleMethod4 = new ModuleMethod(numbersVar, 36, null, 4097);
        moduleMethod4.setProperty("source-location", "numbers.scm:156");
        ...
        real$Mnpart = new ModuleMethod(numbersVar, 39, Lit37, 4097);
        imag$Mnpart = new ModuleMethod(numbersVar, 40, Lit38, 4097);
        magnitude = new ModuleMethod(numbersVar, 41, Lit39, 4097);
        angle = new ModuleMethod(numbersVar, 42, Lit40, 4097);
        inexact = new ModuleMethod(numbersVar, 43, Lit41, 4097);
        exact = new ModuleMethod(numbersVar, 44, Lit42, 4097);
        exact$Mn$Grinexact = new ModuleMethod(numbersVar, 45, Lit43, 4097);
        inexact$Mn$Grexact = new ModuleMethod(numbersVar, 46, Lit44, 4097);
        ...
        logcount = new ModuleMethod(numbersVar, 54, Lit52, 4097);
        bitwise$Mnbit$Mncount = new ModuleMethod(numbersVar, 55, Lit53, 4097);
        bitwise$Mnlength = new ModuleMethod(numbersVar, 56, Lit54, 4097);
        bitwise$Mnfirst$Mnbit$Mnset = new ModuleMethod(numbersVar, 57, Lit55, 4097);
        ...
        quantity$Mn$Grnumber = new ModuleMethod(numbersVar, 64, Lit60, 4097);
        quantity$Mn$Grunit = new ModuleMethod(numbersVar, 65, Lit61, 4097);
        make$Mnquantity = new ModuleMethod(numbersVar, 66, Lit62, 8194);
        duration = new ModuleMethod(numbersVar, 67, Lit63, 4097);
        $instance.run();
    }
