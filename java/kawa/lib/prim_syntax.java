...
public class prim_syntax extends ModuleBody {
    ...
    static {
        ...
        ModuleMethod moduleMethod = new ModuleMethod(prim_syntaxVar, 2, null, 4097);
        ...
        ModuleMethod moduleMethod2 = new ModuleMethod(prim_syntaxVar, 3, null, 4097);
        moduleMethod2.setProperty("source-location", "prim_syntax.scm:89");
        try$Mncatch = Macro.make(simpleSymbol8, moduleMethod2, $instance);
        SimpleSymbol simpleSymbol9 = Lit29;
        ModuleMethod moduleMethod3 = new ModuleMethod(prim_syntaxVar, 4, null, 4097);
        moduleMethod3.setProperty("source-location", "prim_syntax.scm:98");
