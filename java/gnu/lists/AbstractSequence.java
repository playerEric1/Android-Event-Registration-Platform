...
public abstract class AbstractSequence {
    ...
    public Object getPosNext(int ipos) {
        return !hasNext(ipos) ? Sequence.eofValue : get(nextIndex(ipos));
    }

    public Object getPosPrevious(int ipos) {
        int index = nextIndex(ipos);
        return index <= 0 ? Sequence.eofValue : get(index - 1);
    }
    ...
    public static int compare(AbstractSequence seq1, int pos1, AbstractSequence seq2, int pos2) {
        return seq1 == seq2 ? seq1.compare(pos1, pos2) : seq1.stableCompare(seq2);
    }
