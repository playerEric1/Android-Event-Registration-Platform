...
public final class YandexTranslate extends AndroidNonvisibleComponent {
    ...
    public void RequestTranslation(final String languageToTranslateTo, final String textToTranslate) {
        if (this.yandexKey.equals("")) {
            ...
            AsynchUtil.runAsynchronously(new Runnable() { // from class: com.google.appinventor.components.runtime.YandexTranslate.1
    ...
    public void performRequest(String languageToTranslateTo, String textToTranslate) throws IOException, JSONException {
        ...
        if (connection != null) {
            try {
                ...
                JSONArray response = jsonResponse.getJSONArray(PropertyTypeConstants.PROPERTY_TYPE_TEXT);
                final String translation = (String) response.get(0);
                this.activity.runOnUiThread(new Runnable() { // from class: com.google.appinventor.components.runtime.YandexTranslate.2
                    @Override // java.lang.Runnable
                    public void run() {
