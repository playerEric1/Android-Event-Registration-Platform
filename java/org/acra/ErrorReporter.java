...
public class ErrorReporter implements Thread.UncaughtExceptionHandler {
    ...
    public ErrorReporter(Context context, SharedPreferences prefs, boolean enabled) {
        this.enabled = false;
    ...
    /* JADX WARN: Type inference failed for: r1v12, types: [org.acra.ErrorReporter$2] */
    /* JADX WARN: Type inference failed for: r1v18, types: [org.acra.ErrorReporter$1] */
    ...
    private void notifySendReport(String reportFileName) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this.mContext, 0, notificationIntent, Declaration.PACKAGE_ACCESS);
